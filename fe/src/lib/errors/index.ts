export const errors = {
  ...
  INVALID_PATH_PARAM: { result: "Invalid Path Parameter Error", status: 400 },
  INVALID_PARAMS: { result: "Invalid Parameters Error", status: 400 },
  UNAUTHORIZED: { result: "Unauthorized Error", status: 403 },
  ...
  NOT_IMPLEMENTED: { result: "Not Implemented Error", status: 501 },
};
